...
using MajeBug.WebApi.Providers;
using MajeBug.WebApi.Results;
            ...
            using (var tx = dbContext.Database.BeginTransaction())
            {
                ...
                using (var tx2=dataContext.Database.BeginTransaction())
                {
                    ...
                    else
                    {
                        try
                        {
                            var userApp = new User { Id = user.Id, DisplayName = model.Email, BirthDate = null, CreatedAd = DateTime.Now };
